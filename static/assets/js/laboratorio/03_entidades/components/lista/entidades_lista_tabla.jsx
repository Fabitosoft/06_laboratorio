...
export default class Tabla extends Component {
    renderEntidad(entidad) {
        const {eliminarEntidad, actualizarEntidad, notificarAction} = this.props;
            ...
            borrar = <i
                ...
                onClick={() => {
                    eliminarEntidad(entidad, () => {
                        notificarAction(`Se há eliminado la entidad ${entidad.nombre}`)
                    })
                }
                }
            />
            ...
            es_activo = <i
                ...
                onClick={() => {
                    actualizarEntidad({...entidad, activo: false}, response => {
                        notificarAction(`Se há inactivado la entidad ${response.nombre}`)
                    })
                }
                }
            />
            ...
            es_activo = <i
                ...
                onClick={() => {
                    actualizarEntidad({...entidad, activo: true}, response => {
                        notificarAction(`Se há activado la entidad ${response.nombre}`)
                    })
                }
                }
            />
